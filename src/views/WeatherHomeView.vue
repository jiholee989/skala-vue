...
const weatherList = ref([
  { id: 'city_01', name: '서울', temp: 28, feelsLike: 30, status: '맑음', humidity: 55 },
  { id: 'city_02', name: '수원', temp: 24, feelsLike: 23, status: '비', humidity: 82 },
  { id: 'city_03', name: '부산', temp: 26, feelsLike: 27, status: '구름', humidity: 68 },
  { id: 'city_04', name: '제주', temp: 23, feelsLike: 24, status: '흐림', humidity: 75 },
  { id: 'city_05', name: '대전', temp: 29, feelsLike: 31, status: '맑음', humidity: 48 },
])
