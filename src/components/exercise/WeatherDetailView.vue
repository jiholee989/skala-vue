...
const mockDetails = {
  ...
  city_02: { name: '수원', temp: 24, status: '비', humidity: 82, wind: 4.1 },
  city_03: { name: '부산', temp: 26, status: '구름', humidity: 68, wind: 5.0 },
  city_04: { name: '제주', temp: 23, status: '흐림', humidity: 75, wind: 6.2 },
  city_05: { name: '대전', temp: 29, status: '맑음', humidity: 48, wind: 1.8 },
}
